...
|---|---|---|
| **q3, хим. недожог, %** | Уголь, крупный котёл (D>21 кг/с ≈ 75 т/ч): **0**. Мазут/газ: **0.1–0.5** | Табл.8 методики ([методичка Смородина С.Н. и др., СПбГТУРП](https://nizrp.narod.ru/metod/kpte/2019_01_19_01.pdf), стр.156) — зависит от вида топки и топлива |
| **q5, при номин. нагрузке, %** | Ориентировочно **1.0–1.5** для котлов класса ~50 т/ч (уменьшается с ростом мощности котла) | Рис.5, стр.173 той же методички — это график (кривая), не таблица и не формула. Отдельного файла-картинки с этим графиком в репозитории нет, только страница 173 в PDF по ссылке выше; значение в столбце слева — грубая оценка порядка величины на глаз, не выверенное по графику число |
