...
| **q5, при номин. нагрузке, %** | Ориентировочно **1.0–1.5** для котлов класса ~50 т/ч (уменьшается с ростом мощности котла) | Рис.5 методики (это график, не таблица и не формула — точных чисел в проекте не сохранено, значение выше — грубая оценка порядка величины, не расчёт) |
